...
public class Constants {
    ...
    public static final double CPU_WARNING_THRESHOLD = 70.0;
    public static final double CPU_CRITICAL_THRESHOLD = 90.0;
    public static final double MEMORY_WARNING_THRESHOLD = 0.7;
    public static final double MEMORY_CRITICAL_THRESHOLD = 0.9;
    public static final double TEMP_WARNING_THRESHOLD = 60.0;
    public static final double TEMP_CRITICAL_THRESHOLD = 80.0;
    public static final double PLUTO_TEMP_WARNING_THRESHOLD = 70.0;
    public static final double PLUTO_TEMP_CRITICAL_THRESHOLD = 85.0;
    public static final double ZYNQ_TEMP_WARNING_THRESHOLD = 70.0;
    public static final double ZYNQ_TEMP_CRITICAL_THRESHOLD = 85.0;
    public static final int PROXIMITY_THRESHOLD = -60;

    public static final int RSSI_GOOD_THRESHOLD = -60;
    public static final int RSSI_MEDIUM_THRESHOLD = -80;

    public static final double MIN_RSSI_DELTA = 15.0;
    public static final double MIN_DISTANCE = 10.0;
    public static final double MAX_SPEED_MPS = 150.0;
